...
class FrontendGenerator:
    ...
    def generate(self):
        ...
        for endpoint_name, endpoint_config in endpoints.items():
            ...
            # Generate services
            self.services_gen.generate(endpoint_name, endpoint_config, domain)
