...
class PageConfig:
    ...
    def __post_init__(self):
        ...
        if self.name.endswith('Page'):
            ...
            self.base_name = NameStandardizer.to_pascal_case(self.name[:-4])  # Remove "Page" and convert to PascalCase
        else:
            self.base_name = NameStandardizer.to_pascal_case(self.name)  # Convert to PascalCase for proper component names
