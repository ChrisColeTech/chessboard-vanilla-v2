...
import { MobilePreferencesPage } from "../../pages/settings/MobilePreferencesPage";

export const PreferencesPageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("preferences");
  usePageActions("preferences");

  // Internal mobile/desktop switching
  return isMobile ? <MobilePreferencesPage /> : <PreferencesPage />;
};