...
class ProjectCapabilityDetector:
        ...
        try:
            ...
            for item in pages_dir.iterdir():
                if item.is_dir():
                    ...
                    parent_page_pattern = f"{item.name.capitalize()}Page.tsx"
                    parent_main_pattern = f"{item.name.capitalize()}MainPage.tsx"
        ...
        try:
            ...
            for parent_dir in pages_dir.iterdir():
                ...
                try:
                    ...
                    parent_patterns = {
                        f"{parent_name.capitalize()}Page.tsx",
                        f"{parent_name.capitalize()}MainPage.tsx"
                    }
    ...
    def check_parent_exists(self, parent_name: str) -> bool:
        ...
        parent_page_file = parent_dir / f"{parent_name.capitalize()}Page.tsx"
    ...
    def check_child_exists(self, parent_name: str, child_name: str) -> bool:
        ...
        child_page_file = parent_dir / f"{child_name.capitalize()}Page.tsx"
