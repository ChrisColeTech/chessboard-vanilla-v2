...
'''
        ...
        # Generate ui index (removed ActionSheetContainer - now only in action-sheet/)
        ui_index_content = '''// UI components index - ActionSheetContainer moved to action-sheet/
'''
...
'''
    ...
    def generate_missing_dependencies(self):
        ...
        # Skip generating conflicting auth hooks - useAuth will be generated by hooks_generator
        print("  📝 Skipped generating auth hooks (handled by hooks_generator)")
