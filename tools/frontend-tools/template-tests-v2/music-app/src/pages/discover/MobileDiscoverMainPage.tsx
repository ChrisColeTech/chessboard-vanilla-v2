...
interface MobileDiscoverMainPageProps {
  // Add mobile-specific props as needed
}

export const MobileDiscoverMainPage: React.FC<MobileDiscoverMainPageProps> = () => {
  return (
      ...
      >
        ...
        >
          <div className="w-full h-full flex items-center justify-center">
            Mobile Discover Center Content
          </div>
        </div>
