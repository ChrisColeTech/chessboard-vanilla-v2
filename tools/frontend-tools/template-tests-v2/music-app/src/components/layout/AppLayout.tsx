...
import { useActionSheet } from "../../hooks/core/useActionSheet";
    ...
    <div className="relative min-h-screen min-h-[100dvh] bg-background text-foreground">
      ...
      */}
      ...
      <div className="absolute top-10 bottom-[57px] left-0 right-0 z-10">
        ...
        <main className="w-full h-full overflow-hidden main-content-area pt-16 px-4 sm:pt-24">
          {children}
        </main>
      ...
      {/* Music Player Bar - positioned above TabBar */}
      <PlayerBar />
