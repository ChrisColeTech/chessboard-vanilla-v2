...
import { MobileArtistsPage } from "../../pages/search/MobileArtistsPage";

export const ArtistsPageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("artists");
  usePageActions("artists");

  // Internal mobile/desktop switching
  return isMobile ? <MobileArtistsPage /> : <ArtistsPage />;
};