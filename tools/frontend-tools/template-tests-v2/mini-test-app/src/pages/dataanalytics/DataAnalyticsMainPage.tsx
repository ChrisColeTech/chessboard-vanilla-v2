...
interface DataAnalyticsMainPageProps {
  // Add props as needed
}

export const DataAnalyticsMainPage: React.FC<DataAnalyticsMainPageProps> = () => {
  const { data, loading, error } = usePageData("dataanalytics");
    ...
    <div className="uitest-layout-container">
      ...
      >
        ...
        <div 
          ...
          style={{ minHeight: '0', minWidth: '0' }}
        >
          DataAnalytics Bottom Left
        </div>
        <div 
          className="flex items-center justify-center border border-border/50 p-2 rounded"
          style={{ minHeight: '0', minWidth: '0' }}
        >
          DataAnalytics Bottom
        </div>
        <div 
          className="flex items-center justify-center border border-border/50 p-2 rounded"
          style={{ minHeight: '0', minWidth: '0' }}
        >
          DataAnalytics Bottom Right
        </div>
      </div>
    </div>
  );
