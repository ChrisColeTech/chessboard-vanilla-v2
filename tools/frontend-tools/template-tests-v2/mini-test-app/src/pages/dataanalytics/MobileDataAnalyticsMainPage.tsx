...
interface MobileDataAnalyticsMainPageProps {
  // Add mobile-specific props as needed
}

export const MobileDataAnalyticsMainPage: React.FC<MobileDataAnalyticsMainPageProps> = () => {
  return (
      ...
      >
        ...
        >
          <div className="w-full h-full flex items-center justify-center">
            Mobile DataAnalytics Center Content
          </div>
        </div>
