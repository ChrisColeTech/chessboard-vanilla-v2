...
interface TestSectionMainPageProps {
  // Add props as needed
}

export const TestSectionMainPage: React.FC<TestSectionMainPageProps> = () => {
  const { data, loading, error } = usePageData("testsection");
