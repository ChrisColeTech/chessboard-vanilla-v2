...
interface MobileTestBackupMainPageProps {
  // Add mobile-specific props as needed
}

export const MobileTestBackupMainPage: React.FC<MobileTestBackupMainPageProps> = () => {
  return (
      ...
      >
        ...
        >
          <div className="w-full h-full flex items-center justify-center">
            Mobile TestBackup Center Content
          </div>
        </div>
