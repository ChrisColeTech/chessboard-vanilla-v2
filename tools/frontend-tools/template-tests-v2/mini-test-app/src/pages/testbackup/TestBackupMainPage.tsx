...
interface TestBackupMainPageProps {
  // Add props as needed
}

export const TestBackupMainPage: React.FC<TestBackupMainPageProps> = () => {
  const { data, loading, error } = usePageData("testbackup");
