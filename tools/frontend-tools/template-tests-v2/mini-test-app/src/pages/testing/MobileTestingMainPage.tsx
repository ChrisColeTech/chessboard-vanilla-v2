...
interface MobileTestingMainPageProps {
  // Add mobile-specific props as needed
}

export const MobileTestingMainPage: React.FC<MobileTestingMainPageProps> = () => {
  return (
