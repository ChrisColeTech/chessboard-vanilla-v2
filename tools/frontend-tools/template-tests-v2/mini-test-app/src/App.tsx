...
import { GameHubPage } from "./pages/gamehub/GameHubPage";
import { UserManagementPage } from "./pages/usermanagement/UserManagementPage";
import { TestBackupPage } from "./pages/testbackup/TestBackupPage";
import { TestSectionPage } from "./pages/testsection/TestSectionPage";
...
function AppContent() {
  ...
  return (
    ...
    >
      {/* Page routing */}
      {selectedTab === "testing" && <TestingPage />}
      {selectedTab === "dataanalytics" && <DataAnalyticsPage />}
      {selectedTab === "gamehub" && <GameHubPage />}
      {selectedTab === "usermanagement" && <UserManagementPage />}
      {selectedTab === "testbackup" && <TestBackupPage />}
      {selectedTab === "testsection" && <TestSectionPage />}
    </AppLayout>
  );
}
