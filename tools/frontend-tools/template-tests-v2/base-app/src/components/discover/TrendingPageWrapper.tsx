...
import { MobileTrendingPage } from "../../pages/discover/MobileTrendingPage";

export const TrendingPageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("trending");
  usePageActions("trending");

  // Internal mobile/desktop switching
  return isMobile ? <MobileTrendingPage /> : <TrendingPage />;
};