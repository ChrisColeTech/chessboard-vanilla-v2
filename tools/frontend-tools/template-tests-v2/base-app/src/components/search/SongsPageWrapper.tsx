...
import { SongsPage } from "../../pages/search/SongsPage";
import { MobileSongsPage } from "../../pages/search/MobileSongsPage";

export const SongsPageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("songs");
  usePageActions("songs");

  // Internal mobile/desktop switching
  return isMobile ? <MobileSongsPage /> : <SongsPage />;
};