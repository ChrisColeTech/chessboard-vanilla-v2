...
const SplashModal: React.FC = () => {
  const splashModalOpen = useAppStore((state: any) => state.splashModalOpen)
  const splashModalPage = useAppStore((state: any) => state.splashModalPage)
  const closeSplashModal = useAppStore((state: any) => state.closeSplashModal)
