...
import { MobilePlaylistsPage } from "../../pages/library/MobilePlaylistsPage";

export const PlaylistsPageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("playlists");
  usePageActions("playlists");

  // Internal mobile/desktop switching
  return isMobile ? <MobilePlaylistsPage /> : <PlaylistsPage />;
};