...
import { PageOnePage } from "../../pages/testsection/PageOnePage";
import { MobilePageOnePage } from "../../pages/testsection/MobilePageOnePage";

export const PageOnePageWrapper: React.FC = () => {
  // Mobile detection handled in wrapper (Phase 2 Architecture)
  const isMobile = useIsMobile();
  
  // Apply page context
  usePageInstructions("pageone");
  usePageActions("pageone");

  // Internal mobile/desktop switching
  return isMobile ? <MobilePageOnePage /> : <PageOnePage />;
};