...
def main():
    ...
    # Parse routes
    routes_dir = '/mnt/c/Projects/chessboard-vanilla-v2/backend-v2/src/routes'
    ...
    try:
        ...
        # Save files
        output_dir = '/mnt/c/Projects/chessboard-vanilla-v2/tools/backend-tools/swagger-tools'
