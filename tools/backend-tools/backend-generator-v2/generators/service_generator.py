...
class ServiceGenerator:
    ...
    def generate_service(self, entity_info: Dict[str, str], table_name: str, 
        ...
        try:
            ...
            # Ensure standard CRUD methods
            standard_methods = self.template_engine.get_standard_crud_methods(entity, entity_info['entities'], configs)
            all_methods = list(set(methods + standard_methods))
