...
interface MobileWorkerMainPageProps {
  // Add mobile-specific props as needed
}

export const MobileWorkerMainPage: React.FC<MobileWorkerMainPageProps> = () => {
  return (
