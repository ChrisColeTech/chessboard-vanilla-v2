...
import { RegisterPageWrapper } from "../../components/auth/RegisterPageWrapper";
...
export const LoginPage: React.FC<LoginPageProps> = () => {
  ...
  const currentChildPage = useAppStore((state: AppStore) => state.currentChildPage);
  const setCurrentChildPage = useAppStore((state: AppStore) => state.setCurrentChildPage);
