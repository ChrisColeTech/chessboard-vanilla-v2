      ...
      <div className="card-gaming p-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Welcome to the tutorials page. This page handles tutorials operations
            and belongs to the learning domain group.
          </p>
          <div className="mt-6 p-4 bg-card border border-border rounded-lg">
            <h3 className="font-semibold text-sm mb-2">Endpoint: tutorials</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            <div className="p-4 bg-card border border-border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Tutorials functionality will be implemented here
              </p>
            </div>
            <div className="p-4 bg-card border border-border rounded-lg">
