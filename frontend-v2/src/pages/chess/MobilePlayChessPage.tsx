...
interface MobilePlayChessPageProps {
  // Add mobile-specific props as needed
}

export const MobilePlayChessPage: React.FC<MobilePlayChessPageProps> = () => {
  return (
      ...
      >
        ...
        >
          <div className="w-full h-full flex items-center justify-center">
            MobilePlayChess Center Content
          </div>
        </div>
