...
// Auth-specific user types (public/frontend-safe user data)
// Note: Re-exporting User from user-management types barrel
import type { User as UserType } from '../user-management';
